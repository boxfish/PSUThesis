...
\textbf{Actor} & \textbf{Type} & \textbf{Description}\tabularnewline
\midrule 
Operator at the decontamination station (DS1) & Generate event (E1) & E1: The quantity of available rinse tanks in the station (DS1) is
running low.\tabularnewline
\midrule 
Decontamination manager (DM) & Consume event (E1) & Upon receiving E1, DM infers that the station (DS1) cannot work properly
...
After identification of the inventory (INV1) to the victim, the DM
activates the goal to deliver the resource from the inventory to the
station. \tabularnewline
\midrule 
 & Generate event (E2) & E2: A new goal to deliver the resource from (INV1) to the station
(DS1) is activated.\tabularnewline
\midrule 
Inventory manager (IM) & Consume event (E2) & Upon receiving E2, IM starts a new action to deliver the resource.\tabularnewline
\midrule 
...
\midrule 
Transportation manager (TM) & Consume event (E3) & Upon receiving E3, TM starts a new action to transport the resource.\tabularnewline
\midrule 
...
\midrule 
Decontamination manager (DM) & Consume event (E2) & Upon receiving E2, DM removes the action to decontaminate the victim
...
\midrule 
Medical manager (MM) & Consume event (E3) & Upon receiving E3, MM removes the action to treat the victim from
her current responsibility.\tabularnewline
\midrule 
 & Consume event (E5) & Upon receiving E5, DM infers that in order to perform the action to
dispatch a special team to the victim, a medical professional needs
to be assigned to the team sent to the victim. \tabularnewline
\midrule 
 & Perform action & By reviewing the available actors, DM decides on the medical professional
that will be sent to the victim\tabularnewline
\midrule 
 & Generate event (E8) & The medical professional has been assigned to the special team to
the victim.\tabularnewline
\midrule 
Transportation Manager & Consume event (E4) & Upon receiving E4, TM removes the action to evacuate the victim from
her current responsibility.\tabularnewline
\midrule 
