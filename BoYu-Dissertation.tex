...
%\documentclass[phd,12pt,draft]{psuthesis}
...
\fxuselayouts{margin,pdfcnote}
\fxloadtargetlayouts{colorcb}
...
\title{Designing for Awareness Promotion in Large-Scale Distributed Collaborative Activities}
...
\readerfour[]
            {Michael McNeese}
            {Associate Dean for Research, Graduate Studies and Academic Affairs of College of Information Sciences and Technology}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Generates the List of Corrections defined          %
% defined using FixMe package                        %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\listoffixmes
...
\include{Chapter-9/main}
%\include{Chapter-10/main}
%\include{Chapter-11/main}
