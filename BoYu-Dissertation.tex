%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     filename  = "YourName-Dissertation.tex",test
%     version   = "1.2.2",
%     date      = "2006/06/29",
...
\documentclass[phd, draft]{psuthesis}
...
\title{Awareness Promotion for Coordinating Distributed Geo-Collaborative Activities}

% Author and Department
\author{Bo Yu}
\dept{Information Sciences and Technology}
% the degree will be conferred on this date
\degreedate{Spring 2013}
