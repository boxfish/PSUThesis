...
\fxfatal{Elaborate on how the propagation works, three approaches: 1. explicit communication, 2. propagation via the boundary object in overlapping local scopes; 3. implicit feed-through via action completion}
