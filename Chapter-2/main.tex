...
\fxfatal{Changes to the conceptual model: 1. add an intermediate layer between field of work and mental model of it. 2. group the three situation awareness processes together. 3. change the term planning to decision.}
...
\fxfatal{Elaborate on how the propagation works: 1. explicit and implicit via the boundary object in overlapping local scopes; 2. where the propagated awareness knowledge comes from: projection, decision-making, action completion. use a chart to show the combos between these two aspects.}
