...
\fxfatal{The individual processes need to be modified.}
\begin{enumerate}
...
\fxfatal{Elaborate on how each approach in more detail}
...
\fxfatal{This example needs to be revised and elaborated!}
