...
\chapter{Our Approach: Promoting Event-Driven Awareness} % (fold)
...
\section{Supporting Event Perception} % (fold)
\label{sec:supporting_event_perception}

% section supporting_event_perception (end)

\section{Supporting Event Comprehension} % (fold)
\label{sec:supporting_event_comprehension}

% section supporting_event_comprehension (end)

\section{Supporting Event Projection} % (fold)
\label{sec:supporting_event_projection}

% section supporting_event_projection (end)
