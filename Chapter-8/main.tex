...
\section{Understanding the awareness phenomena in the scenario} % (fold)
...
\subsection{Analyzing the characteristics of awareness} % (fold)
...
\section{Simulating the knowledge updating} % (fold)
...
\end{figure}
% subsection episode_1 (end)

\subsection{Episode 2} % (fold)
\label{sub:episode_2}
...
\end{figure}
% subsection episode_2 (end)

\subsection{Episode 3} % (fold)
\label{sub:episode_3}
...
\end{figure}
% subsection episode_3 (end)

\subsection{Episode 4} % (fold)
\label{sub:episode_4}
